...
```
    ...
    <networkx.classes.graph.Graph at 0x7f95f406db50>
...
```
    ...
    [('Eddard-Stark', 0.04552079222830667),
     ...
     ('Robert-Baratheon', 0.029834742227736757),
     ('Jon-Snow', 0.0268344995220662),
     ('Robb-Stark', 0.021562941297247513),
     ('Sansa-Stark', 0.020008034042864643),
...
```
    ...
    [('Eddard-Stark', 0.07239401100498231),
     ('Robert-Baratheon', 0.048517275705099325),
     ('Jon-Snow', 0.047706890624749164),
     ('Tyrion-Lannister', 0.043674378927062774),
     ('Catelyn-Stark', 0.034667034701307366),
     ('Bran-Stark', 0.02977420053980018),
     ('Robb-Stark', 0.029216183645196847),
     ('Daenerys-Targaryen', 0.027089622513021206),
     ('Sansa-Stark', 0.026961778915683122),
     ('Cersei-Lannister', 0.021631679397418918)]
